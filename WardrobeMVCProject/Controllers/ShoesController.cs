...
namespace WardrobeMVCProject.Controllers
{
    public class ShoesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShoesID,ShoesName,ShoesPhoto,ShoesType,ColorID,SeasonID,OccasionID")] Sho sho)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShoesID,ShoesName,ShoesPhoto,ShoesType,ColorID,SeasonID,OccasionID")] Sho sho)
        {
            if (ModelState.IsValid)
            {
