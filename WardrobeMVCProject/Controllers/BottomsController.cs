...
namespace WardrobeMVCProject.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,BottomsName,BottomsPhoto,BottomsType,ColorID,SeasonID,OccasionID")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,BottomsName,BottomsPhoto,BottomsType,ColorID,SeasonID,OccasionID")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
