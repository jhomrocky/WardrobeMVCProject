...
namespace WardrobeMVCProject.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopsID,TopsName,TopsPhoto,TopsType,ColorID,SeasonID,OccasionID")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopsID,TopsName,TopsPhoto,TopsType,ColorID,SeasonID,OccasionID")] Top top)
        {
            if (ModelState.IsValid)
            {
