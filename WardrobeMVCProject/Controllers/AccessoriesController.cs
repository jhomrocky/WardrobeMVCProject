...
namespace WardrobeMVCProject.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoriesID,AccessoriesName,AccessoriesPhoto,AccessoriesType,ColorID,SeasonID,OccasionID")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoriesID,AccessoriesName,AccessoriesPhoto,AccessoriesType,ColorID,SeasonID,OccasionID")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
